 ...
 */
                ...
                package org.apache.axis2.sample.mtom.types;
            

            /**
            *  GetBinaryData bean class
            */
        
        public  class GetBinaryData
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http//axis2.apache.org/sample/mtom/types",
                "getBinaryData",
                "ns1");
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   String namespacePrefix = registerPrefix(xmlWriter,"http//axis2.apache.org/sample/mtom/types");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBinaryData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBinaryData",
                ...
                if (localDataHandlerTracker){
                                    namespace = "http//axis2.apache.org/sample/mtom/types";
        ...
        private static String generatePrefix(String namespace) {
            if(namespace.equals("http//axis2.apache.org/sample/mtom/types")){
                return "ns1";
            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localDataHandlerTracker){
                                      elementList.add(new javax.xml.namespace.QName("http//axis2.apache.org/sample/mtom/types",
                                        "dataHandler"));
    ...
    public static class Factory{
        ...
        */
        public static GetBinaryData parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetBinaryData object =
                new GetBinaryData();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBinaryData".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBinaryData)org.apache.axis2.sample.mtom.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http//axis2.apache.org/sample/mtom/types","dataHandler").equals(reader.getName())){
