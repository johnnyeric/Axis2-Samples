...
%_RUNJAVA% %JAVA_OPTS% -cp "!AXIS2_CLASS_PATH!" org.apache.axis2.schema.XSD2Java -ns2p http//axis2.apache.org/sample/adb/types=org.apache.axis2.sample.adb schema/employee.xsd src 
endlocal
:end
