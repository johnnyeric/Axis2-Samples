...
import org.apache.axis2.sample.wsdl.types.Project;
import org.apache.axis2.sample.wsdl.types.Employee;

public class TestSampleServicesStub {

    public static void main(String[] args) {

        try {
            SampleServiceStub stub =
                    new SampleServiceStub("http://localhost:8088/axis2/services/SampleService");
            stub._getServiceClient().getOptions().setSoapVersionURI(SOAP12Constants.SOAP_ENVELOPE_NAMESPACE_URI);
            String result = stub.echoString("Hello world");
