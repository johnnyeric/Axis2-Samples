            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"echoString".equals(type)){
                                ...
                                return (EchoString)org.apache.axis2.sample.pojo.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http//axis2.apache.org/sample/pojo/types","string").equals(reader.getName())){
