 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":echoStringResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "echoStringResponse",
    ...
    public static class Factory{
        ...
        */
        public static EchoStringResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            EchoStringResponse object =
                new EchoStringResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"echoStringResponse".equals(type)){
                                ...
                                return (EchoStringResponse)org.apache.axis2.sample.pojo.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
