 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static EchoString parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            EchoString object =
                new EchoString();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"echoString".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EchoString)org.apache.axis2.sample.spring.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http//axis2.apache.org/sample/spring/types","string").equals(reader.getName())){
